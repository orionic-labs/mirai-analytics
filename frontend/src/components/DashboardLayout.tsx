                    ...
                    <header className="h-16 border-b border-dashboard-primary/10 bg-card flex items-center  px-6 gap-4">
                        ...
                        <div className="flex-1 max-w-md">
                            <div className="relative">
                                ...
                                <Input placeholder="Search news, clients, markets..." className="pl-10 bg-background border-dashboard-primary/20" />
                            </div>
                        </div>

                        <div className="flex ml-auto items-center gap-3">
                            <Button variant="ghost" size="icon" className=" border border-muted/30 relative">
                                <Bell className="w-4 h-4" />
                                <span className="absolute -top-1 -right-1 w-2 h-2 bg-dashboard-danger rounded-full"></span>
                            </Button>

                            <Button variant="ghost" size="icon" className="border border-muted/30">
